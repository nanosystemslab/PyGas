...
class AlicatFlow:
    ...
    def __init__(
        ...
        Args:
            port (str): The serial port to communicate with the device (default '/dev/tty.usbserial-AU0585NK').
...
class AlicatPressure:
    def __init__(
        ...
        Args:
            port (str, optional): The serial port to connect to (default "/dev/tty.usbserial-AU0585NK").
